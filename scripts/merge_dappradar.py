#!/usr/bin/env python3
"""
Merge DappRadar new projects into the main CSV.
"""
...
NEW_PROJECTS_PATH = BASE_DIR / "Aptos Ecosystem Research" / "dappradar_new_projects.csv"
...
def merge_csvs():
    ...
    print(f"New projects to add: {len(added)}")
